...
import { getPierreAccounts, getPierreBalance, getPierreTransactions, getPierreInstallments, syncPierreData } from "./routes/pierre";
...
export function createServer() {
  ...
  app.get("/api/pierre/balance", getPierreBalance);
